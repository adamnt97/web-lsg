      ...
      <main className="pt-28">
        <div className="max-w-7xl mx-auto px-6">
          ...
          duration: 0.5
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">Transformamos software, espacios y experiencias a través de la innovación y la tecnología</p>
          </motion.div>
